<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="postList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="岗位编号" align="center" prop="post_id" />
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      this.reset();
      const postId = row.post_id || this.ids
    ...
    /** 删除按钮操作 */
    handleDelete(row) {
      const postIds = row.post_id ? [row.post_id] :  this.ids;
