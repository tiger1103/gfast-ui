<template>
  <div class="system-dic-container">
      ...
      <div class="system-user-search mb15">
        <el-form :model="state.tableData.param" ref="queryRef" :inline="true" label-width="68px">
          <el-form-item label="字典名称" prop="dictName">
            <el-input v-model="state.tableData.param.dictName" placeholder="请输入字典名称" clearable size="default"
              style="width: 240px" @keyup.enter.native="typeList" />
          </el-form-item>
          <el-form-item label="字典类型" prop="dictType">
            <el-input v-model="state.tableData.param.dictType" placeholder="请输入字典类型" clearable size="default"
              style="width: 240px" @keyup.enter.native="typeList" />
          </el-form-item>
    ...
    <AddDic ref="addDicRef" @typeList="typeList" />
...
// 引入组件
const AddDic = defineAsyncComponent(() => import('/@/views/system/dict/component/addDic.vue'));
const EditDic = defineAsyncComponent(() => import('/@/views/system/dict/component/editDic.vue'));
