	...
	<div class="system-post-container">
		<el-card shadow="hover">
			<div class="system-user-search mb15">
				<el-form :inline="true">
					<el-form-item label="岗位名称">
						<el-input size="default" v-model="tableData.param.postName" placeholder="请输入岗位名称"
							class="w-50 m-2" clearable />
					</el-form-item>
					<el-form-item label="岗位编码">
						<el-input size="default" v-model="tableData.param.postCode" placeholder="请输入岗位编码"
							class="w-50 m-2" clearable />
					</el-form-item>
			...
			<pagination v-show="tableData.total > 0" :total="tableData.total" v-model:page="tableData.param.pageNum"
				v-model:limit="tableData.param.pageSize" @pagination="postList" />
		</el-card>
