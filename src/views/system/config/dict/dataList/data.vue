...
export default {
  ...
  methods: {
    ...
    handleSelectionChange(selection) {
      this.ids = selection.map(item => item.dict_code)
    ...
    handleUpdate(row) {
      ...
      getData(dictCode).then(response => {
        this.form = {
          dictType:response.data.dict_type,
          dictCode: response.data.dict_code,
          dictLabel: response.data.dict_label,
          dictValue: response.data.dict_value,
          dictSort: response.data.dict_sort,
