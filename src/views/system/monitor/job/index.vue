        ...
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item prop="invokeTarget">
              ...
              <el-input v-model="form.invokeTarget" placeholder="请输入调用方法字符串" />
            </el-form-item>
          </el-col>
          ...
          <el-col :span="24">
            <el-form-item prop="jobParams">
              ...
              <el-input v-model="form.jobParams" placeholder="若有参数，请输入。" />
            </el-form-item>
          </el-col>
          ...
          <el-col :span="24">
            <el-form-item label="执行策略">
              <el-radio-group v-model="form.misfirePolicy">
                <el-radio
                  v-for="dict in jobPolicyOptions"
                  :key="dict.key"
...
export default {
  ...
  created() {
    ...
    this.getDicts("sys_job_group").then(response => {
      this.jobGroupOptions = response.data.values || []
    });
    this.getDicts("sys_job_policy").then(response => {
      this.jobPolicyOptions = response.data.values || []
    });
    this.getList();
  },
  methods: {
    ...
    handleStatusChange(row) {
      ...
      this.$confirm(
        ...
        if(row.status === 0){
          return start(row.jobId);
        } else {
          return stop(row.jobId);
        }
    ...
    handleUpdate(row) {
      ...
      getJob(jobId).then(response => {
        ...
        this.form.misfirePolicy = ''+this.form.misfirePolicy
        this.form.concurrent=''+this.form.concurrent
