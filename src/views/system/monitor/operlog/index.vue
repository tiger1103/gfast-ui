<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="list" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作类型" align="center" prop="request_method"  />
 
      <el-table-column label="操作人员" align="center" prop="oper_name" />

      <el-table-column label="部门名称" align="center" prop="dept_name" />

      <el-table-column label="主机" align="center" prop="oper_ip" width="130" :show-overflow-tooltip="true" />
      ...
      <el-form ref="form" :model="form" label-width="100px" size="mini">
        <el-row>
          <el-col :span="12">
            ...
            <el-form-item
              label="登录信息："
            >{{ form.oper_name }} / {{ form.dept_name }} / {{ form.oper_ip }} / {{ form.oper_location }}</el-form-item>
...
export default {
  ...
  methods: {
    ...
    /** 删除按钮操作 */
    handleDelete(row) {
      const operIds = row.oper_id || this.ids;
